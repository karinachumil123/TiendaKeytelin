...
- Create Angular project with ng: `ng new tiendakeytlin.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`tiendakeytlin.client.esproj`).
